...
class TableReferencesTest extends DatabaseBackedTestCase
{
    ...
    {
        $references = new TableReferences(self::$connection, new TableName('employees'));
    ...
    {
        $references = new TableReferences(self::$connection, new TableName('public', 'employees'));
    ...
    {
        $references = new TableReferences(self::$connection, new TableName('fkey_test', 'documents'));
    ...
    {
        $references = new TableReferences(self::$connection, new TableName('fkey_test', 'documents_tags'));
    ...
    public function testMetadataIsStoredInCache(): void
    {
        ...
        new TableReferences(self::$connection, new TableName('fkey_test', 'documents_comments'));
    }
    ...
    public function testMetadataIsLoadedFromCache(): void
    {
        ...
        $references = new TableReferences(self::$connection, new TableName('fkey_test', 'documents_comments'));
