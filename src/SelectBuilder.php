 ...
 *
 * This is a common interface for queries created by
 * {@see \sad_spirit\pg_gateway\TableGateway::select() TableGateway::select()} and those created by
 * {@see \sad_spirit\pg_builder\Parser Parser} from SQL strings.
 *
 * @since 0.4.0
 */
